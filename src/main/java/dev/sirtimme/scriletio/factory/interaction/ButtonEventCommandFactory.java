...
public class ButtonEventCommandFactory implements IInteractionCommandFactory<ButtonInteractionEvent> {
    ...
    public ButtonEventCommandFactory(final LocalizationManager l10nManager) {
        ...
        registerButtonCommand("register-accept", context -> new RegisterAcceptButton(new UserRepository(context), l10nManager));
        registerButtonCommand("register-cancel", _ -> new RegisterCancelButton(l10nManager));
        registerButtonCommand("delete-accept", context -> new DeleteAcceptButton(new UserRepository(context), new DeleteConfigRepository(context), l10nManager));
        registerButtonCommand("delete-cancel", _ -> new DeleteCancelButton(l10nManager));
    }
